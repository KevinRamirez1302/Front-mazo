const courses = [
  {
    emoji: '💻', badge: 'Grado Superior', badgeStyle: 'bg-accent text-white',
    title: 'Desarrollo de Aplicaciones Multiplataforma', short: 'DAM',
  ...
  {
    emoji: '🖧', badge: 'Grado Medio', badgeStyle: 'bg-accent-dark text-white',
    title: 'Sistemas Microinformáticos y Redes', short: 'SMR',
    duration: '2 años · 2.000 horas',
